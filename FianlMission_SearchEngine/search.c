...
int NUM = 0;                                                    
int trie[2000000][26];                                          //字典树 (1128344)
int words[2000000][2];                                          //0列单词表 1列关键词映射
int pos = 1, pagecnt;                                           //字典树编号 网页编号
int p, i, j, temp, sgn;
char word_dictionary[100], word_stopwords[100];                   //字典单词 停用词单词
char article[200000000];                                        //储存网页集合
...
//处理网页集合
    article_len =  fread(article, sizeof(char), 200000000, fp_article);
    fclose(fp_article);
